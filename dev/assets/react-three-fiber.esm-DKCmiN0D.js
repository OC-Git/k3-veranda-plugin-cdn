import { R as React, v as veranda_mf_2_plugin__loadShare__react__loadShare__ } from './veranda_mf_2_plugin__loadShare__react__loadShare__-CVrN7QH5.js';
import { v as veranda_mf_2_plugin__loadShare__three__loadShare__, T as THREE } from './veranda_mf_2_plugin__loadShare__three__loadShare__-DpQQB08m.js';
import { c as createStore$1, u as useSyncExternalStoreExports, s as suspend, p as preload, a as clear, T as Tb, b as schedulerExports } from './index-CJzfn2LJ.js';
...
const a = /* @__PURE__ */ l(/* @__PURE__ */ veranda_mf_2_plugin__loadShare__react__loadShare__.createContext(null));
class m extends veranda_mf_2_plugin__loadShare__react__loadShare__.Component {
  render() {
    return /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react__loadShare__.createElement(a.Provider, { value: this._reactInternals }, this.props.children);
  }
}
function c() {
  const e = veranda_mf_2_plugin__loadShare__react__loadShare__.useContext(a);
  if (e === null) throw new Error("its-fine: useFiber must be called within a <FiberProvider />!");
  const t = veranda_mf_2_plugin__loadShare__react__loadShare__.useId();
...
function h() {
  const e = c(), [t] = veranda_mf_2_plugin__loadShare__react__loadShare__.useState(() => /* @__PURE__ */ new Map());
  t.clear();
  let r = e;
  for (; r; ) {
    const n = r.type;
    b(n) && n !== a && !t.has(n) && t.set(n, veranda_mf_2_plugin__loadShare__react__loadShare__.use(l(n))), r = r.return;
  }
  return t;
}
function x() {
  ...
  return veranda_mf_2_plugin__loadShare__react__loadShare__.useMemo(
    () => Array.from(e.keys()).reduce(
      (t, r) => (n) => /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react__loadShare__.createElement(t, null, /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react__loadShare__.createElement(r.Provider, { ...n, value: e.get(r) })),
      (t) => /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react__loadShare__.createElement(m, { ...t })
    ),
    [e]
  );
}
...
function useBridge() {
  ...
  return veranda_mf_2_plugin__loadShare__react__loadShare__.useMemo(() => ({
    ...
    const strict = !!i$1(fiber, true, (node) => node.type === veranda_mf_2_plugin__loadShare__react__loadShare__.StrictMode);
    const Root = strict ? veranda_mf_2_plugin__loadShare__react__loadShare__.StrictMode : veranda_mf_2_plugin__loadShare__react__loadShare__.Fragment;
    return /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(Root, {
      children: /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(ContextBridge, {
        children
      })
    });
  }, [fiber, ContextBridge]);
...
const ErrorBoundary = /* @__PURE__ */ ((_ErrorBoundary) => (_ErrorBoundary = class ErrorBoundary extends veranda_mf_2_plugin__loadShare__react__loadShare__.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      error: false
...
function applyProps(object, props) {
  ...
  for (const prop in props) {
    ...
    if (target instanceof veranda_mf_2_plugin__loadShare__three__loadShare__.Layers && value instanceof veranda_mf_2_plugin__loadShare__three__loadShare__.Layers) {
      target.mask = value.mask;
    } else if (target instanceof veranda_mf_2_plugin__loadShare__three__loadShare__.Color && isColorRepresentation(value)) {
      target.set(value);
      ...
      root[key].format === veranda_mf_2_plugin__loadShare__three__loadShare__.RGBAFormat && root[key].type === veranda_mf_2_plugin__loadShare__three__loadShare__.UnsignedByteType) {
        root[key].colorSpace = veranda_mf_2_plugin__loadShare__three__loadShare__.SRGBColorSpace;
      }
    }
  }
    ...
    if (intersections.length) {
      ...
      for (const hit of intersections) {
        ...
        if (state2) {
          ...
          const unprojectedPoint = new veranda_mf_2_plugin__loadShare__three__loadShare__.Vector3(pointer.x, pointer.y, 0).unproject(camera);
...
const context = /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react__loadShare__.createContext(null);
const createStore = (invalidate2, advance2) => {
  const rootStore = createWithEqualityFn((set, get) => {
    const position = new veranda_mf_2_plugin__loadShare__three__loadShare__.Vector3();
    const defaultTarget = new veranda_mf_2_plugin__loadShare__three__loadShare__.Vector3();
    const tempTarget = new veranda_mf_2_plugin__loadShare__three__loadShare__.Vector3();
    ...
    const pointer = new veranda_mf_2_plugin__loadShare__three__loadShare__.Vector2();
    const rootState = {
      set,
      get,
      ...
      flat: false,
      controls: null,
      clock: new veranda_mf_2_plugin__loadShare__three__loadShare__.Clock(),
      pointer,
      mouse: pointer,
      frameloop: "always",
      ...
      internal: {
        ...
        lastEvent: /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react__loadShare__.createRef(),
        // Updates
        active: false,
        frames: 0,
        priority: 0,
...
function useInstanceHandle(ref) {
  const instance = veranda_mf_2_plugin__loadShare__react__loadShare__.useRef(null);
  veranda_mf_2_plugin__loadShare__react__loadShare__.useImperativeHandle(instance, () => ref.current.__r3f, [ref]);
  return instance;
}
function useStore() {
  const store = veranda_mf_2_plugin__loadShare__react__loadShare__.useContext(context);
...
function useGraph(object) {
  return veranda_mf_2_plugin__loadShare__react__loadShare__.useMemo(() => buildGraph(object), [object]);
}
    ...
    Tt.exports = function(m) {
      ...
      function fu(t2) {
        ...
        for (var a = t2, l = r2; ; ) {
          ...
          if (c.child === d.child) {
            for (d = c.child; d; ) {
              if (d === a) return du(c), t2;
              if (d === l) return du(c), r2;
              d = d.sibling;
            }
            throw Error(F(188));
          }
      ...
      function Lr(t2, r2, a) {
        ...
        if (l === 0) return 0;
        var c = 0, d = t2.suspendedLanes, h = t2.pingedLanes;
        t2 = t2.warmLanes;
        var y = l & 134217727;
        return y !== 0 ? (l = y & ~d, l !== 0 ? c = Zo(l) : (h &= y, h !== 0 ? c = Zo(h) : a || (a = y & ~t2, a !== 0 && (c = Zo(a))))) : (y = l & ~d, y !== 0 ? c = Zo(y) : h !== 0 ? c = Zo(h) : a || (a = l & ~t2, a !== 0 && (c = Zo(a)))), c === 0 ? 0 : r2 !== 0 && r2 !== c && (r2 & d) === 0 && (d = c & -c, a = r2 & -r2, d >= a || d === 32 && (a & 4194048) !== 0) ? r2 : c;
      }
      function Pi(t2, r2) {
      ...
      function _p(t2, r2, a, l, c, d) {
        ...
        l !== 0 && Yo(t2, l, 0), d !== 0 && c === 0 && t2.tag !== 0 && (t2.suspendedLanes |= d & ~(h & ~r2));
      }
      function Yo(t2, r2, a) {
...
` + R[l].replace(" at new ", " at ");
                  return t2.displayName && j.includes("<anonymous>") && (j = j.replace("<anonymous>", t2.displayName)), j;
                }
              while (1 <= l && 0 <= c);
              break;
            }
...
` + l.stack;
      ...
      function Ci(t2, r2, a) {
        ...
        if (30 < d) {
          var h = c - c % 5;
          d = (l & (1 << h) - 1).toString(32), l >>= h, c -= h, ot = 1 << 32 - vt(r2) + c | a << c | l, Zr = d + t2;
        } else ot = 1 << d | a << c | l, Zr = t2;
      }
      function Id(t2) {
        ...
        for (var c = r2, d = false; c !== null; ) {
          ...
          if (c.tag === 10) {
            ...
            if (h = h.memoizedProps, h !== null) {
              var y = c.type;
              jn(c.pendingProps.value, h.value) || (t2 !== null ? t2.push(y) : t2 = [y]);
            }
          } else if (c === Fc.current) {
            if (h = c.alternate, h === null) throw Error(F(387));
            h.memoizedState.memoizedState !== c.memoizedState.memoizedState && (t2 !== null ? t2.push(da) : t2 = [da]);
          }
          c = c.return;
        }
            ...
            for (var a = false, l = an; l !== null; ) {
              if (t2 !== 0) {
                ...
                if (c === 0) var d = 0;
                  ...
                  d = (1 << 31 - vt(42 | t2) + 1) - 1, d &= c & ~(h & ~y), d = d & 201326741 ? d & 201326741 | 1 : d ? d | 2 : 0;
                }
                d !== 0 && (a = true, Su(l, d));
      ...
      function Lp() {
        ...
        for (var r2 = ze(), a = null, l = an; l !== null; ) {
          var c = l.next, d = vu(l, r2);
          d === 0 ? (l.next = null, a === null ? an = c : a.next = c, c === null && (wt = a)) : (a = l, (t2 !== 0 || (d & 3) !== 0) && (ll = true)), l = c;
        }
        Re !== 0 && Re !== 5 || Ea(t2), Pr !== 0 && (Pr = 0);
      }
      function vu(t2, r2) {
        for (var a = t2.suspendedLanes, l = t2.pingedLanes, c = t2.expirationTimes, d = t2.pendingLanes & -62914561; 0 < d; ) {
          var h = 31 - vt(d), y = 1 << h, R = c[h];
          R === -1 ? ((y & a) === 0 || (y & l) !== 0) && (c[h] = Tp(y, r2)) : R <= r2 && (t2.expiredLanes |= y), d &= ~y;
        }
      ...
      function ho(t2, r2) {
        ...
        return t2.then(function() {
          ...
          for (var c = 0; c < a.length; c++) (0, a[c])(r2);
        }, function(c) {
      ...
      function Ul(t2, r2) {
        ...
        for (l = 0; l < a.length; l++) {
          var c = a[l];
          if (!Bf.call(r2, c) || !jn(t2[c], r2[c])) return false;
        }
        return true;
      }
      function Hd(t2) {
      ...
      function Ii(t2, r2, a) {
        ...
        var l = t2.alternate;
        l !== null && (l.lanes |= a);
        for (var c = false, d = t2.return; d !== null; ) d.childLanes |= a, l = d.alternate, l !== null && (l.childLanes |= a), d.tag === 22 && (t2 = d.stateNode, t2 === null || t2._visibility & 1 || (c = true)), t2 = d, d = d.return;
        return t2.tag === 3 ? (d = t2.stateNode, c && r2 !== null && (c = 31 - vt(a), t2 = d.hiddenUpdates, l = t2[c], l === null ? t2[c] = [r2] : l.push(r2), r2.lane = a | 536870912), d) : null;
      }
      function Fa(t2) {
      ...
      function Nr(t2, r2, a) {
        ...
        if (l = l.shared, (ce & 2) !== 0) {
          var c = l.pending;
          return c === null ? r2.next = r2 : (r2.next = c.next, c.next = r2), l.pending = r2, r2 = Fa(t2), Ii(t2, null, a), r2;
        }
        ...
        if (d !== null) {
          ...
          do {
            ...
            if (V ? (he & W) === W : (l & W) === W) {
              ...
              W = y.callback, W !== null && (t2.flags |= 64, V && (t2.flags |= 8192), V = c.callbacks, V === null ? c.callbacks = [W] : V.push(W));
            } else V = {
              lane: W,
              tag: y.tag,
              payload: y.payload,
          ...
          j === null && (R = A), c.baseState = R, c.firstBaseUpdate = L, c.lastBaseUpdate = j, d === null && (c.shared.lanes = 0), ba |= h, t2.lanes = h, t2.memoizedState = A;
        }
      }
      function Dd(t2, r2) {
      ...
      function $l(t2, r2, a, l, c, d) {
        return Wo = d, ne = r2, r2.memoizedState = null, r2.updateQueue = null, r2.lanes = 0, M.H = t2 === null || t2.memoizedState === null ? Mh : qf, oi = false, d = a(l, c), oi = false, dl && (d = xu(r2, a, l, c)), Fi(t2), d;
      }
      function Fi(t2) {
        M.H = Os;
      ...
      function xu(t2, r2, a, l) {
        ...
        do {
          ...
          if (c += 1, pn = Ie = null, t2.updateQueue != null) {
      ...
      function Po(t2, r2, a) {
        ...
        var c = t2.baseQueue, d = l.pending;
        if (d !== null) {
          if (c !== null) {
            var h = c.next;
            c.next = d.next, d.next = h;
          }
          r2.baseQueue = c = d, l.pending = null;
        }
        if (d = t2.baseState, c === null) t2.memoizedState = d;
        else {
          r2 = c.next;
          var y = h = null, R = null, L = r2, j = false;
          do {
          ...
          if (R === null ? h = d : R.next = y, !jn(d, t2.memoizedState) && (hn = true, j && (a = ul, a !== null))) throw a;
          t2.memoizedState = d, t2.baseState = h, t2.baseQueue = R, l.lastRenderedState = d;
        }
        return c === null && (l.lanes = 0), [t2.memoizedState, l.dispatch];
      }
      function Da(t2) {
        var r2 = He(), a = r2.queue;
        if (a === null) throw Error(F(311));
        a.lastRenderedReducer = t2;
        var l = a.dispatch, c = a.pending, d = r2.memoizedState;
        if (c !== null) {
          a.pending = null;
          var h = c = c.next;
          do
      ...
      function ur(t2, r2, a) {
        ...
        if (h && (c.memoizedState = a, hn = true), c = c.queue, Tu(ql.bind(null, l, c, t2), [t2]), c.getSnapshot !== r2 || h || pn !== null && pn.memoizedState.tag & 1) {
          if (l.flags |= 2048, Kn(9, {
            destroy: void 0
          }, jr.bind(null, l, c, a, r2), null), Ne === null) throw Error(F(349));
      ...
      function cr(t2, r2) {
        var a = r2.action, l = r2.payload, c = t2.state;
        if (r2.isTransition) {
          var d = M.T, h = {};
          M.T = h;
          try {
      ...
      function pr(t2, r2) {
        ...
        return l = Ln(), c = {
          ...
          action: t2,
          pending: null
        }, l.queue = c, a = Dr.bind(null, ne, c, d, a), c.dispatch = a, l.memoizedState = t2, [r2, a, false];
      }
      function Ud(t2) {
        var r2 = He();
        return hr(r2, Ie, t2);
      ...
      function hr(t2, r2, a) {
        ...
        r2 = He();
        var c = r2.queue, d = c.dispatch;
        return a !== r2.memoizedState && (ne.flags |= 2048, Kn(9, {
          destroy: void 0
        }, Zl.bind(null, c, a), null)), [l, d, t2];
      }
      function Zl(t2, r2) {
        t2.action = r2;
      }
      ...
      function Xl(t2, r2, a, l) {
        var c = Ln();
        ne.flags |= t2, c.memoizedState = Kn(1 | r2, {
          destroy: void 0
        }, a, l === void 0 ? null : l);
      }
      function Di(t2, r2, a, l) {
        ...
        Ie !== null && l !== null && wo(l, Ie.memoizedState.deps) ? c.memoizedState = Kn(r2, d, a, l) : (ne.flags |= t2, c.memoizedState = Kn(1 | r2, d, a, l));
      }
      function Bd(t2, r2) {
        Xl(8390656, 8, t2, r2);
      }
      ...
      function ea(t2, r2, a, l) {
        ...
        if (na(t2)) Gd(r2, c);
          ...
          if (t2.lanes === 0 && (d === null || d.lanes === 0) && (d = r2.lastRenderedReducer, d !== null)) try {
            ...
            if (c.hasEagerState = true, c.eagerState = y, jn(y, h)) return go(t2, r2, c, 0), Ne === null && Bn(), false;
          } catch {
          } finally {
          }
          if (a = yo(t2, r2, c, l), a !== null) return nt(a, t2, l), ns(a, r2, l), true;
        }
        return false;
      }
      ...
      function ts(t2, r2, a, l, c, d, h) {
        return t2 = t2.stateNode, typeof t2.shouldComponentUpdate == "function" ? t2.shouldComponentUpdate(l, d, h) : r2.prototype && r2.prototype.isPureReactComponent ? !Ul(a, l) || !Ul(c, d) : true;
      }
      ...
      function Wr(t2, r2) {
        ...
        if (t2 = t2.defaultProps) {
          a === r2 && (a = Lt({}, a));
          for (var c in t2) a[c] === void 0 && (a[c] = t2[c]);
        }
        return a;
      }
      function rs(t2, r2) {
      ...
      function Hu(t2, r2, a, l) {
        ...
        h !== null && typeof h.componentDidCatch == "function" && (t2.callback = function() {
          Zd(r2, a, l), typeof c != "function" && (va === null ? va = /* @__PURE__ */ new Set([this]) : va.add(this));
          var y = l.stack;
      ...
      function On(t2, r2, a, l, c) {
        if (a.flags |= 32768, l !== null && typeof l == "object" && typeof l.then == "function") {
          if (r2 = a.alternate, r2 !== null && po(r2, a, c, true), a = Ft.current, a !== null) {
            switch (a.tag) {
              case 31:
              case 13:
                return zr === null ? Gi() : a.alternate === null && Xe === 0 && (Xe = 3), a.flags &= -257, a.flags |= 65536, a.lanes = c, l === Dc ? a.flags |= 16384 : (r2 = a.updateQueue, r2 === null ? a.updateQueue = /* @__PURE__ */ new Set([l]) : r2.add(l), lc(t2, l, c)), false;
              case 22:
                return a.flags |= 65536, l === Dc ? a.flags |= 16384 : (r2 = a.updateQueue, r2 === null ? (r2 = {
                  transitions: null,
                  markerInstances: null,
                  retryQueue: /* @__PURE__ */ new Set([l])
                }, a.updateQueue = r2) : (a = r2.retryQueue, a === null ? r2.retryQueue = /* @__PURE__ */ new Set([l]) : a.add(l)), lc(t2, l, c)), false;
            }
            throw Error(F(435, a.tag));
          }
          return lc(t2, l, c), Gi(), false;
        }
        if (ue) return r2 = Ft.current, r2 !== null ? ((r2.flags & 65536) === 0 && (r2.flags |= 256), r2.flags |= 65536, r2.lanes = c, l !== Of && (t2 = Error(F(422), {
          cause: l
        }), ct(ut(t2, a)))) : (l !== Of && (r2 = Error(F(423), {
          cause: l
        }), ct(ut(r2, a))), t2 = t2.current.alternate, t2.flags |= 65536, c &= -c, t2.lanes |= c, l = ut(l, a), c = Ui(t2.stateNode, l, c), jd(t2, c), Xe !== 4 && (Xe = 2)), false;
        var d = Error(F(520), {
          cause: l
        });
        ...
        do {
          switch (a.tag) {
            case 3:
              return a.flags |= 65536, t2 = c & -c, a.lanes |= t2, t2 = Ui(a.stateNode, l, t2), jd(a, t2), false;
            case 1:
              if (r2 = a.type, d = a.stateNode, (a.flags & 128) === 0 && (typeof r2.getDerivedStateFromError == "function" || d !== null && typeof d.componentDidCatch == "function" && (va === null || !va.has(d)))) return a.flags |= 65536, c &= -c, a.lanes |= c, c = os(c), Hu(c, t2, a, l), jd(a, c), false;
          }
          a = a.return;
        } while (a !== null);
        return false;
      ...
      function as(t2, r2, a, l, c) {
        ...
        return Un(r2), l = $l(t2, r2, a, h, d, c), y = Hr(), t2 !== null && !hn ? (lr(t2, r2, c), gt(t2, r2, c)) : (ue && y && Id(r2), r2.flags |= 1, wn(t2, r2, l, c), r2.child);
      }
      function Au(t2, r2, a, l, c) {
        if (t2 === null) {
          var d = a.type;
          return typeof d == "function" && !ks(d) && d.defaultProps === void 0 && a.compare === null ? (r2.tag = 15, r2.type = d, ju(t2, r2, d, l, c)) : (t2 = ws(a.type, null, l, r2, r2.mode, c), t2.ref = r2.ref, t2.return = r2, r2.child = t2);
        }
        if (d = t2.child, !Mi(t2, c)) {
          var h = d.memoizedProps;
          if (a = a.compare, a = a !== null ? a : Ul, a(h, l) && t2.ref === r2.ref) return gt(t2, r2, c);
        }
        return r2.flags |= 1, t2 = Qr(d, l), t2.ref = r2.ref, t2.return = r2, r2.child = t2;
      }
      function ju(t2, r2, a, l, c) {
        if (t2 !== null) {
          var d = t2.memoizedProps;
          if (Ul(d, l) && t2.ref === r2.ref) if (hn = false, r2.pendingProps = l = d, Mi(t2, c)) (t2.flags & 131072) !== 0 && (hn = true);
          else return r2.lanes = t2.lanes, gt(t2, r2, c);
        }
        return Yd(t2, r2, a, l, c);
      }
      function zo(t2, r2, a, l) {
        var c = l.children, d = t2 !== null ? t2.memoizedState : null;
        if (t2 === null && r2.stateNode === null && (r2.stateNode = {
          ...
          if ((r2.flags & 128) !== 0) {
            if (d = d !== null ? d.baseLanes | a : a, t2 !== null) {
              for (l = r2.child = t2.child, c = 0; l !== null; ) c = c | l.lanes | l.childLanes, l = l.sibling;
              l = c & ~d;
      ...
      function Bi(t2, r2, a, l, c) {
        ...
        return d = d === null ? null : {
          ...
          baseLanes: a,
          cachePool: d
        }, t2 !== null && Ei(r2, null), Ql(), Fr(r2), t2 !== null && po(t2, r2, l, true), r2.childLanes = c, null;
      }
      function Ua(t2, r2) {
        return r2 = mr({
          mode: r2.mode,
      ...
      function is2(t2, r2, a) {
        var l = r2.pendingProps, c = (r2.flags & 128) !== 0;
        ...
        if (d !== null) {
          ...
          } else if (hn || po(t2, r2, a, false), c = (a & t2.childLanes) !== 0, hn || c) {
      ...
      function Kd(t2, r2, a, l, c) {
        if (Un(r2), r2.stateNode === null) {
          ...
          j = typeof A == "function" || typeof d.getSnapshotBeforeUpdate == "function", y = r2.pendingProps !== y, j || typeof d.UNSAFE_componentWillReceiveProps != "function" && typeof d.componentWillReceiveProps != "function" || (y || L !== h) && Jd(r2, d, l, h), ma = false;
          var W = r2.memoizedState;
          d.state = W, Aa(r2, l, d, c), Li(), L = r2.memoizedState, y || W !== L || ma ? (typeof A == "function" && (Fu(r2, a, A, l), L = r2.memoizedState), (R = ma || ts(r2, a, R, l, W, L, h)) ? (j || typeof d.UNSAFE_componentWillMount != "function" && typeof d.componentWillMount != "function" || (typeof d.componentWillMount == "function" && d.componentWillMount(), typeof d.UNSAFE_componentWillMount == "function" && d.UNSAFE_componentWillMount()), typeof d.componentDidMount == "function" && (r2.flags |= 4194308)) : (typeof d.componentDidMount == "function" && (r2.flags |= 4194308), r2.memoizedProps = l, r2.memoizedState = L), d.props = l, d.state = L, d.context = h, l = R) : (typeof d.componentDidMount == "function" && (r2.flags |= 4194308), l = false);
        } else {
          d = r2.stateNode, Ha(t2, r2), h = r2.memoizedProps, j = Wr(a, h), d.props = j, A = r2.pendingProps, W = d.context, L = a.contextType, R = Ka, typeof L == "object" && L !== null && (R = In(L)), y = a.getDerivedStateFromProps, (L = typeof y == "function" || typeof d.getSnapshotBeforeUpdate == "function") || typeof d.UNSAFE_componentWillReceiveProps != "function" && typeof d.componentWillReceiveProps != "function" || (h !== A || W !== R) && Jd(r2, d, l, R), ma = false, W = r2.memoizedState, d.state = W, Aa(r2, l, d, c), Li();
          var V = r2.memoizedState;
          h !== A || W !== V || ma || t2 !== null && t2.dependencies !== null && Ri(t2.dependencies) ? (typeof y == "function" && (Fu(r2, a, y, l), V = r2.memoizedState), (j = ma || ts(r2, a, j, l, W, V, R) || t2 !== null && t2.dependencies !== null && Ri(t2.dependencies)) ? (L || typeof d.UNSAFE_componentWillUpdate != "function" && typeof d.componentWillUpdate != "function" || (typeof d.componentWillUpdate == "function" && d.componentWillUpdate(l, V, R), typeof d.UNSAFE_componentWillUpdate == "function" && d.UNSAFE_componentWillUpdate(l, V, R)), typeof d.componentDidUpdate == "function" && (r2.flags |= 4), typeof d.getSnapshotBeforeUpdate == "function" && (r2.flags |= 1024)) : (typeof d.componentDidUpdate != "function" || h === t2.memoizedProps && W === t2.memoizedState || (r2.flags |= 4), typeof d.getSnapshotBeforeUpdate != "function" || h === t2.memoizedProps && W === t2.memoizedState || (r2.flags |= 1024), r2.memoizedProps = l, r2.memoizedState = V), d.props = l, d.state = V, d.context = R, l = j) : (typeof d.componentDidUpdate != "function" || h === t2.memoizedProps && W === t2.memoizedState || (r2.flags |= 4), typeof d.getSnapshotBeforeUpdate != "function" || h === t2.memoizedProps && W === t2.memoizedState || (r2.flags |= 1024), l = false);
        }
        return d = l, ls(t2, r2), l = (r2.flags & 128) !== 0, d || l ? (d = r2.stateNode, a = l && typeof a.getDerivedStateFromError != "function" ? null : d.render(), r2.flags |= 1, t2 !== null && l ? (r2.child = ri(r2, t2.child, null, c), r2.child = ri(r2, null, a, c)) : wn(t2, r2, a, c), r2.memoizedState = d.state, t2 = r2.child) : t2 = gt(t2, r2, c), t2;
      }
      ...
      function Wu(t2, r2, a) {
        var l = r2.pendingProps, c = false, d = (r2.flags & 128) !== 0, h;
        if ((h = d) || (h = t2 !== null && t2.memoizedState === null ? false : (ln.current & 2) !== 0), h && (c = true, r2.flags &= -129), h = (r2.flags & 32) !== 0, r2.flags &= -33, t2 === null) {
          if (ue) {
            if (c ? vo(r2) : So(), (t2 = Ue) ? (t2 = Om(t2, Yt), t2 !== null && (r2.memoizedState = {
              dehydrated: t2,
              treeContext: jo !== null ? {
                id: ot,
                overflow: Zr
          ...
          var y = l.children;
          return l = l.fallback, c ? (So(), c = r2.mode, y = mr({
            mode: "hidden",
            children: y
          }, c), l = Eo(l, c, a, null), y.return = r2, l.return = r2, y.sibling = l, r2.child = y, l = r2.child, l.memoizedState = ss(a), l.childLanes = Ur(t2, h, a), r2.memoizedState = Qc, Mt(null, l)) : (vo(r2), Uu(r2, y));
        }
        var R = t2.memoizedState;
        if (R !== null && (y = R.dehydrated, y !== null)) {
          if (d) r2.flags & 256 ? (vo(r2), r2.flags &= -257, r2 = et(t2, r2, a)) : r2.memoizedState !== null ? (So(), r2.child = t2.child, r2.flags |= 128, r2 = null) : (So(), y = l.fallback, c = r2.mode, l = mr({
            mode: "visible",
            children: l.children
          }, c), y = Eo(y, c, a, null), y.flags |= 2, l.return = r2, y.return = r2, l.sibling = y, r2.child = l, ri(r2, t2.child, null, a), l = r2.child, l.memoizedState = ss(a), l.childLanes = Ur(t2, h, a), r2.memoizedState = Qc, r2 = Mt(null, l));
        ...
        return c ? (So(), y = l.fallback, c = r2.mode, R = t2.child, d = R.sibling, l = Qr(R, {
          mode: "hidden",
          children: l.children
        }), l.subtreeFlags = R.subtreeFlags & 65011712, d !== null ? y = Qr(d, y) : (y = Eo(y, c, a, null), y.flags |= 2), y.return = r2, l.return = r2, l.sibling = y, r2.child = l, Mt(null, l), l = r2.child, y = t2.child.memoizedState, y === null ? y = ss(a) : (c = y.cachePool, c !== null ? (R = qt ? qe._currentValue : qe._currentValue2, c = c.parent !== R ? {
          parent: R,
          pool: R
        } : c) : c = Pu(), y = {
      ...
      function ee(t2, r2, a, l, c, d) {
        ...
        h === null ? t2.memoizedState = {
          ...
          tailMode: c,
          treeForkCount: d
        } : (h.isBackwards = r2, h.rendering = null, h.renderingStartTime = 0, h.last = l, h.tail = a, h.tailMode = c, h.treeForkCount = d);
      }
      function N(t2, r2, a) {
        var l = r2.pendingProps, c = l.revealOrder, d = l.tail;
        l = l.children;
        var h = ln.current, y = (h & 2) !== 0;
        if (y ? (h = h & 1 | 2, r2.flags |= 128) : h &= 1, Ce(ln, h), wn(t2, r2, l, a), l = ue ? x : 0, !y && t2 !== null && (t2.flags & 128) !== 0) e: for (t2 = r2.child; t2 !== null; ) {
        ...
        switch (c) {
          case "forwards":
            for (a = r2.child, c = null; a !== null; ) t2 = a.alternate, t2 !== null && ko(t2) === null && (c = a), a = a.sibling;
            a = c, a === null ? (c = r2.child, r2.child = null) : (c = a.sibling, a.sibling = null), ee(r2, false, c, a, d, l);
            break;
          case "backwards":
          case "unstable_legacy-backwards":
            for (a = null, c = r2.child, r2.child = null; c !== null; ) {
              if (t2 = c.alternate, t2 !== null && ko(t2) === null) {
                r2.child = c;
                break;
              }
              t2 = c.sibling, c.sibling = a, a = c, c = t2;
            }
      ...
      function Ye(t2, r2, a) {
        switch (r2.tag) {
          ...
          case 13:
            ...
            break;
          case 19:
            var c = (t2.flags & 128) !== 0;
            if (l = (a & r2.childLanes) !== 0, l || (po(t2, r2, a, false), l = (a & r2.childLanes) !== 0), c) {
              if (l) return N(t2, r2, a);
              r2.flags |= 128;
            }
            if (c = r2.memoizedState, c !== null && (c.rendering = null, c.tail = null, c.lastEffect = null), Ce(ln, ln.current), l) break;
            return null;
          case 22:
      ...
      function Bu(t2, r2, a) {
        ...
        switch (r2.lanes = 0, r2.tag) {
          ...
          case 1:
            return l = r2.type, c = Wr(l, r2.pendingProps), Kd(t2, r2, l, c, a);
          case 3:
            e: {
              if (Al(r2, r2.stateNode.containerInfo), t2 === null) throw Error(F(387));
              var d = r2.pendingProps;
              c = r2.memoizedState, l = c.element, Ha(t2, r2), Aa(r2, d, null, a);
              var h = r2.memoizedState;
              if (d = h.cache, fo(r2, qe, d), d !== c.cache && _i(r2, [qe], a, true), Li(), d = h.element, Hn && c.isDehydrated) {
                if (c = {
                  element: d,
                  isDehydrated: false,
                  cache: h.cache
                }, r2.updateQueue.baseState = c, r2.memoizedState = c, r2.flags & 256) {
                  r2 = Du(t2, r2, d, a);
                  break e;
                } else if (d !== l) {
          ...
          case 5:
            return t2 === null && ue && ($m(r2.type, r2.pendingProps, Dn.current), (c = l = Ue) && (l = Bm(l, r2.type, r2.pendingProps, Yt), l !== null ? (r2.stateNode = l, bn = r2, Ue = wc(l), Yt = false, c = true) : c = false), c || ar(r2)), yu(r2), c = r2.type, d = r2.pendingProps, h = t2 !== null ? t2.memoizedProps : null, l = d.children, Rs(c, d) ? l = null : h !== null && Rs(c, h) && (r2.flags |= 32), r2.memoizedState !== null && (c = $l(t2, r2, zu, null, null, a), qt ? da._currentValue = c : da._currentValue2 = c), ls(t2, r2), wn(t2, r2, l, a), r2.child;
          case 6:
          ...
          case 9:
            return c = r2.type._context, l = r2.pendingProps.children, Un(r2), c = In(c), l = l(c), r2.flags |= 1, wn(t2, r2, l, a), r2.child;
          case 14:
          ...
          case 24:
            return Un(r2), l = In(qe), t2 === null ? (c = wu(), c === null && (c = Ne, d = Fd(), c.pooledCache = d, d.refCount++, d !== null && (c.pooledCacheLanes |= a), c = d), r2.memoizedState = {
              parent: l,
              cache: c
            }, Ol(r2), fo(r2, qe, c)) : ((t2.lanes & a) !== 0 && (Ha(t2, r2), Aa(r2, null, null, a), Li()), c = t2.memoizedState, d = r2.memoizedState, c.parent !== l ? (c = {
              parent: l,
              cache: l
            }, r2.memoizedState = c, r2.lanes === 0 && (r2.memoizedState = r2.updateQueue.baseState = c), fo(r2, qe, l)) : (l = d.cache, fo(r2, qe, l), l !== c.cache && _i(r2, [qe], a, true))), wn(t2, r2, r2.pendingProps.children, a), r2.child;
          case 29:
      ...
      function ef(t2, r2, a, l) {
        if ($n) for (a = r2.child; a !== null; ) {
        ...
        else if (Sr) for (var c = r2.child; c !== null; ) {
          if (c.tag === 5) {
            var d = c.stateNode;
            a && l && (d = No(d, c.type, c.memoizedProps)), yc(t2, d);
          } else if (c.tag === 6) d = c.stateNode, a && l && (d = Ls(d, c.memoizedProps)), yc(t2, d);
          else if (c.tag !== 4) {
            if (c.tag === 22 && c.memoizedState !== null) d = c.child, d !== null && (d.return = c), ef(t2, c, true, true);
          ...
          if (c === r2) break;
          for (; c.sibling === null; ) {
            if (c.return === null || c.return === r2) return;
            c = c.return;
          }
      ...
      function Mu(t2, r2, a, l) {
        ...
        if (Sr) for (var d = r2.child; d !== null; ) {
          if (d.tag === 5) {
            ...
            if (d.tag === 22 && d.memoizedState !== null) c = d.child, c !== null && (c.return = d), Mu(t2, d, true, true), c = true;
          ...
          if (d === r2) break;
          for (; d.sibling === null; ) {
            if (d.return === null || d.return === r2) return c;
            d = d.return;
          }
      ...
      function ds(t2, r2, a, l) {
        if ($n) t2.memoizedProps !== l && It(r2);
          ...
          var c = t2.stateNode, d = t2.memoizedProps;
          if ((t2 = Ou(t2, r2)) || d !== l) {
            var h = Dn.current;
            d = gh(c, a, d, l, !t2, null), d === c ? r2.stateNode = c : (cs(r2), Kp(d, a, l, h) && It(r2), r2.stateNode = d, t2 && ef(d, r2, false, false));
          } else r2.stateNode = c;
        }
      }
      function Fn(t2, r2, a, l, c) {
        if ((t2.mode & 32) !== 0 && (a === null ? rh(r2, l) : Dm(r2, a, l))) {
          if (t2.flags |= 16777216, (c & 335544128) === c || Yi(r2, l)) if (An(t2.stateNode, r2, l)) t2.flags |= 8192;
      ...
      function we(t2) {
        ...
        if (r2) for (var c = t2.child; c !== null; ) a |= c.lanes | c.childLanes, l |= c.subtreeFlags & 65011712, l |= c.flags & 65011712, c.return = t2, c = c.sibling;
        else for (c = t2.child; c !== null; ) a |= c.lanes | c.childLanes, l |= c.subtreeFlags, l |= c.flags, c.return = t2, c = c.sibling;
      ...
      function Oa(t2, r2, a) {
        ...
        switch (gu(r2), r2.tag) {
          ...
          case 26:
            if (Gt) {
              var c = r2.type, d = r2.memoizedState;
              return t2 === null ? (It(r2), d !== null ? (we(r2), xe(r2, d)) : (we(r2), Fn(r2, c, null, l, a))) : d ? d !== t2.memoizedState ? (It(r2), we(r2), xe(r2, d)) : (we(r2), r2.flags &= -16777217) : (d = t2.memoizedProps, $n ? d !== l && It(r2) : ds(t2, r2, c, l), we(r2), Fn(r2, c, d, l, a)), null;
            }
          case 27:
            if (dn) {
              if (jl(r2), a = pa.current, c = r2.type, t2 !== null && r2.stateNode != null) $n ? t2.memoizedProps !== l && It(r2) : ds(t2, r2, c, l);
              else {
                if (!l) {
                  if (r2.stateNode === null) throw Error(F(166));
                  return we(r2), null;
                }
                t2 = Dn.current, Ti(r2) ? Ep(r2, t2) : (t2 = _c(c, l, a, t2, true), r2.stateNode = t2, It(r2));
              }
              return we(r2), null;
            }
          case 5:
            if (jl(r2), c = r2.type, t2 !== null && r2.stateNode != null) ds(t2, r2, c, l);
            else {
              if (!l) {
                if (r2.stateNode === null) throw Error(F(166));
                return we(r2), null;
              }
              if (d = Dn.current, Ti(r2)) Ep(r2, d), Eh(r2.stateNode, c, l, d) && (r2.flags |= 64);
              else {
                var h = Vr(c, l, pa.current, d, r2);
                cs(r2), ef(h, r2, false, false), r2.stateNode = h, Kp(h, c, l, d) && It(r2);
              }
            }
          ...
          case 6:
            if (t2 && r2.stateNode != null) a = t2.memoizedProps, $n ? a !== l && It(r2) : Sr && (a !== l ? (t2 = pa.current, a = Dn.current, cs(r2), r2.stateNode = bc(l, t2, a, r2)) : r2.stateNode = t2.stateNode);
              ...
              if (t2 = pa.current, a = Dn.current, Ti(r2)) {
                ...
                if (t2 = r2.stateNode, a = r2.memoizedProps, l = null, c = bn, c !== null) switch (c.tag) {
                  case 27:
                  case 5:
                    l = c.memoizedProps;
                }
          ...
          case 13:
            if (l = r2.memoizedState, t2 === null || t2.memoizedState !== null && t2.memoizedState.dehydrated !== null) {
              if (c = Ti(r2), l !== null && l.dehydrated !== null) {
                if (t2 === null) {
                  if (!c) throw Error(F(318));
                  if (!Hn) throw Error(F(344));
                  if (c = r2.memoizedState, c = c !== null ? c.dehydrated : null, !c) throw Error(F(317));
                  Hf(c, r2);
                } else _a(), (r2.flags & 128) === 0 && (r2.memoizedState = null), r2.flags |= 4;
                we(r2), c = false;
              } else c = Dl(), t2 !== null && t2.memoizedState !== null && (t2.memoizedState.hydrationErrors = c), c = true;
              if (!c) return r2.flags & 256 ? (ht(r2), r2) : (ht(r2), null);
            }
            return ht(r2), (r2.flags & 128) !== 0 ? (r2.lanes = a, r2) : (a = l !== null, t2 = t2 !== null && t2.memoizedState !== null, a && (l = r2.child, c = null, l.alternate !== null && l.alternate.memoizedState !== null && l.alternate.memoizedState.cachePool !== null && (c = l.alternate.memoizedState.cachePool.pool), d = null, l.memoizedState !== null && l.memoizedState.cachePool !== null && (d = l.memoizedState.cachePool.pool), d !== c && (l.flags |= 2048)), a !== t2 && a && (r2.child.flags |= 8192), Ba(r2, r2.updateQueue), we(r2), null);
          case 4:
          ...
          case 19:
            ...
            if (c = (r2.flags & 128) !== 0, d = l.rendering, d === null) {
              if (c) Co(l, false);
              else {
                ...
                l.tail !== null && ze() > ml && (r2.flags |= 128, c = true, Co(l, false), r2.lanes = 4194304);
              }
            } else {
              if (!c) if (t2 = ko(d), t2 !== null) {
                if (r2.flags |= 128, c = true, t2 = t2.updateQueue, r2.updateQueue = t2, Ba(r2, t2), Co(l, true), l.tail === null && l.tailMode === "hidden" && !d.alternate && !ue) return we(r2), null;
              } else 2 * ze() - l.renderingStartTime > ml && a !== 536870912 && (r2.flags |= 128, c = true, Co(l, false), r2.lanes = 4194304);
              l.isBackwards ? (d.sibling = r2.child, r2.child = d) : (t2 = l.last, t2 !== null ? t2.sibling = d : r2.child = d, l.last = d);
            }
            return l.tail !== null ? (t2 = l.tail, l.rendering = t2, l.tail = t2.sibling, l.renderingStartTime = ze(), t2.sibling = null, a = ln.current, Ce(ln, c ? a & 1 | 2 : a & 1), ue && or(r2, l.treeForkCount), t2) : (we(r2), null);
          case 22:
          case 23:
      ...
      function Or(t2, r2, a) {
        try {
          var l = r2.updateQueue, c = l !== null ? l.lastEffect : null;
          if (c !== null) {
            var d = c.next;
            l = d;
            do {
      ...
      function Wp(t2, r2) {
        for (Am(t2.containerInfo), Pn = r2; Pn !== null; ) if (t2 = Pn, r2 = t2.child, (t2.subtreeFlags & 1028) !== 0 && r2 !== null) r2.return = t2, Pn = r2;
          ...
          switch (r2 = t2.flags, t2.tag) {
            ...
            case 1:
              if ((r2 & 1024) !== 0 && a !== null) {
                r2 = void 0, l = t2, c = a.memoizedProps, a = a.memoizedState;
                var d = l.stateNode;
                try {
                  var h = Wr(l.type, c);
        ...
        switch (a.tag) {
          ...
          case 1:
            if ($t(t2, a), l & 4) if (t2 = a.stateNode, r2 === null) try {
              ...
              var c = Wr(a.type, r2.memoizedProps);
              r2 = r2.memoizedState;
              try {
                t2.componentDidUpdate(c, r2, t2.__reactInternalSnapshotBeforeUpdate);
              } catch (h) {
                ve(a, a.return, h);
              }
            }
          ...
          case 5:
            if ($t(t2, a), r2 === null) {
              if (l & 4) nf(a);
                ...
                t2 = a.type, r2 = a.memoizedProps, c = a.stateNode;
                try {
                  _h(c, t2, r2, a);
                } catch (h) {
                  ve(a, a.return, h);
          ...
          case 22:
            if (l = a.memoizedState !== null || eo, !l) {
              r2 = r2 !== null && r2.memoizedState !== null || sn, c = eo;
              var d = sn;
              eo = l, (sn = r2) && !d ? br(t2, a, (a.subtreeFlags & 8772) !== 0) : $t(t2, a), eo = c, sn = d;
            }
            break;
          case 30:
            break;
        ...
        switch (a.tag) {
          ...
          case 27:
            if (dn) {
              sn || yr(a, r2);
              var l = mn, c = Pt;
              Xa(a.type) && (mn = a.stateNode, Pt = false), Qt(t2, r2, a), fa(a.stateNode), mn = l, Pt = c;
              break;
            }
          case 5:
            sn || yr(a, r2);
          case 6:
            if ($n) {
              if (l = mn, c = Pt, mn = null, Qt(t2, r2, a), mn = l, Pt = c, mn !== null) if (Pt) try {
                If(mn, a.stateNode);
              } catch (d) {
                ve(a, r2, d);
              }
          ...
          case 18:
            ...
            break;
          case 4:
            $n ? (l = mn, c = Pt, mn = a.stateNode.containerInfo, Pt = true, Qt(t2, r2, a), mn = l, Pt = c) : (Sr && Ju(a.stateNode, a, We()), Qt(t2, r2, a));
            break;
          case 0:
          case 11:
          case 14:
        ...
        switch (t2.tag) {
          ...
          case 26:
            if (Gt) {
              ...
              if (tn(r2, t2), Mn(t2), l & 512 && (sn || a === null || yr(a, a.return)), l & 4) {
                ...
                var d = t2.memoizedState;
                a === null ? d === null ? t2.stateNode === null ? t2.stateNode = Ya(c, t2.type, t2.memoizedProps, t2) : Cc(c, t2.type, t2.stateNode) : t2.stateNode = Fh(c, d, t2.memoizedProps) : l !== d ? (l === null ? a.stateNode !== null && Wf(a.stateNode) : Hh(l), d === null ? Cc(c, t2.type, t2.stateNode) : Fh(c, d, t2.memoizedProps)) : d === null && t2.stateNode !== null && qu(t2, t2.memoizedProps, a.memoizedProps);
              }
              break;
            }
          case 27:
          ...
          case 5:
            if (tn(r2, t2), Mn(t2), l & 512 && (sn || a === null || yr(a, a.return)), $n) {
              ...
              l & 4 && t2.stateNode != null && (c = t2.memoizedProps, qu(t2, c, a !== null ? a.memoizedProps : c)), l & 1024 && (Ms = true);
          ...
          case 6:
            if (tn(r2, t2), Mn(t2), l & 4 && $n) {
              ...
              l = t2.memoizedProps, a = a !== null ? a.memoizedProps : l, c = t2.stateNode;
              try {
                Is(c, a, l);
              } catch (A) {
                ve(t2, t2.return, A);
            ...
            break;
          case 3:
            if (Gt ? (jh(), c = Cr, Cr = zc(r2.containerInfo), tn(r2, t2), Cr = c) : tn(r2, t2), Mn(t2), l & 4) {
          ...
          case 13:
            ...
            break;
          case 22:
            c = t2.memoizedState !== null;
            var h = a !== null && a.memoizedState !== null, y = eo, R = sn;
            if (eo = y || c, sn = R || h, tn(r2, t2), sn = R, eo = y, Mn(t2), l & 8192 && (r2 = t2.stateNode, r2._visibility = c ? r2._visibility & -2 : r2._visibility | 1, c && (a === null || h || eo || sn || Vt(t2)), $n)) {
      ...
      function br(t2, r2, a) {
        for (a = a && (r2.subtreeFlags & 8772) !== 0, r2 = r2.child; r2 !== null; ) {
          var l = r2.alternate, c = t2, d = r2, h = d.flags;
          switch (d.tag) {
            case 0:
            case 11:
            case 15:
      ...
      function Mp(t2, r2, a, l) {
        ...
        switch (r2.tag) {
          ...
          case 11:
          case 15:
            yt(t2, r2, a, l), c & 2048 && Br(9, r2);
            break;
          case 1:
            yt(t2, r2, a, l);
            break;
          case 3:
            yt(t2, r2, a, l), c & 2048 && (t2 = null, r2.alternate !== null && (t2 = r2.alternate.memoizedState.cache), r2 = r2.memoizedState.cache, r2 !== t2 && (r2.refCount++, t2 != null && Ra(t2)));
            break;
          case 12:
            if (c & 2048) {
          ...
          case 23:
            break;
          case 22:
            d = r2.stateNode, h = r2.alternate, r2.memoizedState !== null ? d._visibility & 2 ? yt(t2, r2, a, l) : oa(t2, r2) : d._visibility & 2 ? yt(t2, r2, a, l) : (d._visibility |= 2, ra(t2, r2, a, l, (r2.subtreeFlags & 10256) !== 0 || false)), c & 2048 && To(h, r2);
            break;
          case 24:
            yt(t2, r2, a, l), c & 2048 && Qn(r2.alternate, r2);
            break;
          default:
            yt(t2, r2, a, l);
        }
      }
      function ra(t2, r2, a, l, c) {
        for (c = c && ((r2.subtreeFlags & 10256) !== 0 || false), r2 = r2.child; r2 !== null; ) {
        ...
        switch (t2.tag) {
          case 26:
            if (_o(t2, r2, a), t2.flags & ga) if (t2.memoizedState !== null) Fo(a, Cr, t2.memoizedState, t2.memoizedProps);
              ...
              var l = t2.stateNode, c = t2.type;
              t2 = t2.memoizedProps, ((r2 & 335544128) === r2 || Yi(c, t2)) && Vn(a, l, c, t2);
            }
            break;
          case 5:
            _o(t2, r2, a), t2.flags & ga && (l = t2.stateNode, c = t2.type, t2 = t2.memoizedProps, ((r2 & 335544128) === r2 || Yi(c, t2)) && Vn(a, l, c, t2));
            break;
          case 3:
          case 4:
          ...
          case qc:
            e: {
              for (r2 = r2.value, t2 = [t2, 0], a = 0; a < t2.length; ) {
                var l = t2[a++], c = l.tag, d = t2[a++], h = r2[d];
      ...
      function sf(t2, r2) {
        ...
        for (var l = 0; l < t2.length; ) {
          var c = t2[l++], d = c.tag, h = t2[l++], y = r2[h];
          if (d !== 5 && d !== 26 && d !== 27 || !Jr(c)) {
            for (; y != null && ms(c, y); ) h++, y = r2[h];
            if (h === r2.length) a.push(c);
            else for (c = c.child; c !== null; ) t2.push(c, h), c = c.sibling;
          }
        }
        return a;
      }
      function gs(t2, r2) {
        ...
        for (var a = 0; a < t2.length; ) {
          var l = t2[a++], c = l.tag;
          if (c === 5 || c === 26 || c === 27) Jr(l) || r2.push(l.stateNode);
      ...
      function uf(t2, r2, a) {
        ...
        var l = !a && (r2 & 127) === 0 && (r2 & t2.expiredLanes) === 0 || Pi(t2, r2), c = l ? Gp(t2, r2) : Ji(t2, r2, true), d = l;
        do {
          if (c === 0) {
            ...
            e: {
              ...
              if ((r2 & 62914560) === r2 && (c = Vs + 300 - ze(), 10 < c)) {
                if (Ro(l, r2, At, !ya), Lr(l, 0, true) !== 0) break e;
                no = r2, l.timeoutHandle = eh(tc.bind(null, l, a, xt, Xc, Yc, r2, At, ii, hl, ya, d, "Throttled", -0, 0), c);
                break e;
              }
      ...
      function tc(t2, r2, a, l, c, d, h, y, R, L, j, A, W, V) {
        if (t2.timeoutHandle = Lo, A = r2.subtreeFlags, A & 8192 || (A & 16785408) === 16785408) {
          ...
          if (Oe = ah(A, Oe), Oe !== null) {
            no = d, t2.cancelPendingCommit = Oe(pf.bind(null, t2, r2, d, a, l, c, h, y, R, j, A, null, W, V)), Ro(t2, d, h, !L);
            return;
          }
        }
        pf(t2, r2, d, a, l, c, h, y, R);
      }
      function Qp(t2) {
        for (var r2 = t2; ; ) {
          var a = r2.tag;
      ...
      function Ji(t2, r2, a) {
        ...
        while (true);
        return r2 && t2.shellSuspendCounter++, Be = at = null, ce = l, M.H = c, M.A = d, de === null && (Ne = null, he = 0, Bn()), h;
      }
      function qp() {
        for (; de !== null; ) rc(de);
      }
      ...
      function pf(t2, r2, a, l, c, d, h, y, R) {
        ...
        if (r2 !== null) {
          ...
          if (d = r2.lanes | r2.childLanes, d |= $f, _p(t2, a, d, h, y, R), t2 === Ne && (de = Ne = null, he = 0), Sa = r2, Bo = t2, no = a, Kc = d, ed = c, $h = l, (r2.subtreeFlags & 10256) !== 0 || (r2.flags & 10256) !== 0 ? (t2.callbackNode = null, t2.callbackPriority = 0, Nm(Ao, function() {
            return hf(), null;
      ...
      function ic() {
        if (Re === 4 || Re === 3) {
          ...
          var c = t2.pendingLanes;
          if (c === 0 && (va = null), Ze(a), r2 = r2.stateNode, on && typeof on.onCommitFiberRoot == "function") try {
            on.onCommitFiberRoot(ei, r2, void 0, (r2.current.flags & 128) === 128);
          } catch {
          }
          if (l !== null) {
            r2 = M.T, c = qr(), yn(2), M.T = null;
            try {
          ...
          (no & 3) !== 0 && rn(), ir(t2), c = t2.pendingLanes, (a & 261930) !== 0 && (c & 42) !== 0 ? t2 === nd ? gl++ : (gl = 0, nd = t2) : gl = 0, Hn && Ih(), Ea(0);
        }
      }
      function Jp(t2, r2) {
      ...
      function lc(t2, r2, a) {
        ...
        if (l === null) {
          ...
          l.set(r2, c);
        } else c = l.get(r2), c === void 0 && (c = /* @__PURE__ */ new Set(), l.set(r2, c));
        c.has(a) || (Gf = true, c.add(a), t2 = Ss.bind(null, t2, r2, a), r2.then(t2, t2));
      }
      function Ss(t2, r2, a) {
        var l = t2.pingCache;
      ...
      function Zp(t2, r2) {
        ...
        switch (t2.tag) {
          case 31:
          case 13:
            var l = t2.stateNode, c = t2.memoizedState;
      ...
      function ws(t2, r2, a, l, c, d) {
        ...
        if (l = t2, typeof t2 == "function") ks(t2) && (h = 1);
          ...
          case gc:
            return t2 = Yn(31, a, r2, c), t2.elementType = gc, t2.lanes = d, t2;
          case $a:
            return Eo(a.children, c, d, r2);
          case kf:
            h = 8, c |= 24;
            break;
          case Cs:
            return t2 = Yn(12, a, r2, c | 2), t2.elementType = Cs, t2.lanes = d, t2;
          case Va:
            return t2 = Yn(13, a, r2, c), t2.elementType = Va, t2.lanes = d, t2;
          case Te:
            return t2 = Yn(19, a, r2, c), t2.elementType = Te, t2.lanes = d, t2;
          default:
        ...
        return r2 = Yn(h, a, r2, c), r2.elementType = t2, r2.type = l, r2.lanes = d, r2;
      }
      ...
      function bf(t2, r2, a, l, c, d, h, y, R) {
      ...
      function xs(t2, r2, a, l, c, d, h, y, R, L, j, A) {
        return t2 = new bf(t2, r2, a, h, R, L, j, A, y), r2 = 1, d === true && (r2 |= 24), d = Yn(3, null, null, r2), t2.current = d, d.stateNode = t2, r2 = Fd(), r2.refCount++, t2.pooledCache = r2, r2.refCount++, d.memoizedState = {
          element: l,
          isDehydrated: a,
          cache: r2
        }, Ol(d), t2;
      ...
      function pc(t2, r2, a, l, c, d) {
        c = fc(c), l.context === null ? l.context = c : l.pendingContext = c, l = Et(r2), l.payload = {
          element: a
      ...
      var Mh = {
        ...
        useReducer: function(t2, r2, a) {
          ...
          return l.memoizedState = l.baseState = c, t2 = {
            pending: null,
            lanes: 0,
            dispatch: null,
        ...
        useSyncExternalStore: function(t2, r2, a) {
          ...
          return c.queue = d, Bd(ql.bind(null, l, d, t2), [t2]), l.flags |= 2048, Kn(9, {
            destroy: void 0
      ...
      var Oc = {
        enqueueSetState: function(t2, r2, a) {
          ...
          var l = bt(), c = Et(l);
          c.payload = r2, a != null && (c.callback = a), r2 = Nr(t2, c, l), r2 !== null && (nt(r2, t2, l), Ml(r2, t2, l));
        },
        enqueueReplaceState: function(t2, r2, a) {
          t2 = t2._reactInternals;
          var l = bt(), c = Et(l);
          c.tag = 1, c.payload = r2, a != null && (c.callback = a), r2 = Nr(t2, c, l), r2 !== null && (nt(r2, t2, l), Ml(r2, t2, l));
        },
      ...
      return ie.attemptContinuousHydration = function(t2) {
      ...
      }, ie.createContainer = function(t2, r2, a, l, c, d, h, y, R, L) {
      ...
      }, ie.createHydrationContainer = function(t2, r2, a, l, c, d, h, y, R, L, j, A, W, V) {
        var _r2;
        return t2 = xs(a, l, true, t2, c, d, y, V, R, L, j, A), t2.context = fc(null), a = t2.current, l = bt(), l = st(l), c = Et(l), c.callback = (_r2 = r2) != null ? _r2 : null, Nr(a, c, l), r2 = l, t2.current.lanes = r2, xi(t2, r2), ir(t2), t2;
      ...
      }, ie.discreteUpdates = function(t2, r2, a, l, c) {
        var d = M.T, h = qr();
        try {
          return yn(2), M.T = null, t2(r2, a, l, c);
        } finally {
        ...
        for (r2 = t2.length - 1; 0 < r2; r2--) {
          a = t2[r2];
          for (var l = a.x, c = l + a.width, d = a.y, h = d + a.height, y = r2 - 1; 0 <= y; y--) if (r2 !== y) {
            var R = t2[y], L = R.x, j = L + R.width, A = R.y, W = A + R.height;
            if (l >= L && d >= A && c <= j && h <= W) {
              t2.splice(r2, 1);
              break;
            } else if (l !== L || a.width !== R.width || W < d || A > h) {
              if (!(d !== A || a.height !== R.height || j < l || L > c)) {
                L > l && (R.width += L - l, R.x = l), j < c && (R.width = c - L), t2.splice(r2, 1);
                break;
              }
            } else {
        ...
        var a = 0, l = [];
        t2 = [Vi(t2), 0];
        for (var c = 0; c < t2.length; ) {
          var d = t2[c++], h = d.tag, y = t2[c++], R = r2[y];
...
const reconciler = /* @__PURE__ */ createReconciler({
  ...
  HostTransitionContext: /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react__loadShare__.createContext(null),
...
function createRoot(canvas) {
  ...
  return {
    async configure(props = {}) {
      ...
      if (!state2.gl) {
        ...
        if (isRenderer(customRenderer)) {
          ...
          gl = new veranda_mf_2_plugin__loadShare__three__loadShare__.WebGLRenderer({
            ...defaultProps,
            ...glConfig
          });
        }
      ...
      if (!raycaster) state2.set({
        raycaster: raycaster = new veranda_mf_2_plugin__loadShare__three__loadShare__.Raycaster()
      });
      const {
        params,
        ...options
      ...
      if (!state2.camera || state2.camera === lastCamera && !is.equ(lastCamera, cameraOptions, shallowLoose)) {
        ...
        const camera = isCamera ? cameraOptions : orthographic ? new veranda_mf_2_plugin__loadShare__three__loadShare__.OrthographicCamera(0, 0, 0, 0, 0.1, 1e3) : new veranda_mf_2_plugin__loadShare__three__loadShare__.PerspectiveCamera(75, 0, 0.1, 1e3);
        if (!isCamera) {
          camera.position.z = 5;
          if (cameraOptions) {
      ...
      if (!state2.scene) {
        ...
        if (sceneOptions != null && sceneOptions.isScene) {
          ...
          scene = new veranda_mf_2_plugin__loadShare__three__loadShare__.Scene();
          prepare(scene, store, "", {});
      ...
      if (gl.shadowMap) {
        ...
        if (is.boo(shadows)) {
          ...
          var _types$shadows;
          const types = {
            basic: veranda_mf_2_plugin__loadShare__three__loadShare__.BasicShadowMap,
            percentage: veranda_mf_2_plugin__loadShare__three__loadShare__.PCFShadowMap,
            soft: veranda_mf_2_plugin__loadShare__three__loadShare__.PCFSoftShadowMap,
            variance: veranda_mf_2_plugin__loadShare__three__loadShare__.VSMShadowMap
          };
          gl.shadowMap.type = (_types$shadows = types[shadows]) != null ? _types$shadows : veranda_mf_2_plugin__loadShare__three__loadShare__.PCFSoftShadowMap;
        } else if (is.obj(shadows)) {
          Object.assign(gl.shadowMap, shadows);
        }
        if (oldEnabled !== gl.shadowMap.enabled || oldType !== gl.shadowMap.type) gl.shadowMap.needsUpdate = true;
      }
      veranda_mf_2_plugin__loadShare__three__loadShare__.ColorManagement.enabled = !legacy;
      if (!configured) {
        gl.outputColorSpace = linear ? veranda_mf_2_plugin__loadShare__three__loadShare__.LinearSRGBColorSpace : veranda_mf_2_plugin__loadShare__three__loadShare__.SRGBColorSpace;
        gl.toneMapping = flat ? veranda_mf_2_plugin__loadShare__three__loadShare__.NoToneMapping : veranda_mf_2_plugin__loadShare__three__loadShare__.ACESFilmicToneMapping;
      }
    ...
    render(children) {
      ...
      pending.then(() => {
        reconciler.updateContainer(/* @__PURE__ */ veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(Provider, {
          store,
          children,
          onCreated,
          rootElement: canvas
...
function Provider({
  ...
  return /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(context.Provider, {
    value: store,
    children
  });
}
...
function createPortal(children, container, state2) {
  return /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(Portal, {
    children,
    container,
    state: state2
  });
...
function Portal({
  ...
  const [raycaster] = veranda_mf_2_plugin__loadShare__react__loadShare__.useState(() => new veranda_mf_2_plugin__loadShare__three__loadShare__.Raycaster());
  const [pointer] = veranda_mf_2_plugin__loadShare__react__loadShare__.useState(() => new veranda_mf_2_plugin__loadShare__three__loadShare__.Vector2());
  const inject = useMutableCallback((rootState, injectState) => {
    let viewport = void 0;
    if (injectState.camera && size) {
      const camera = injectState.camera;
      viewport = rootState.viewport.getCurrentViewport(camera, new veranda_mf_2_plugin__loadShare__three__loadShare__.Vector3(), size);
  ...
  const usePortalStore = veranda_mf_2_plugin__loadShare__react__loadShare__.useMemo(() => {
  ...
  return (
    ...
    /* @__PURE__ */ veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.Fragment, {
      children: reconciler.createPortal(/* @__PURE__ */ veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(context.Provider, {
...
function g(n,t){let o;return (...i)=>{window.clearTimeout(o),o=window.setTimeout(()=>n(...i),t);}}function j({debounce:n,scroll:t,polyfill:o,offsetSize:i}={debounce:0,scroll:false,offsetSize:false}){const a=o||(typeof window=="undefined"?class{}:window.ResizeObserver);if(!a)throw new Error("This browser does not support ResizeObserver out of the box. See: https://github.com/react-spring/react-use-measure/#resize-observer-polyfills");const[c,h]=veranda_mf_2_plugin__loadShare__react__loadShare__.useState({left:0,top:0,width:0,height:0,bottom:0,right:0,x:0,y:0}),e=veranda_mf_2_plugin__loadShare__react__loadShare__.useRef({element:null,scrollContainers:null,resizeObserver:null,lastBounds:c,orientationHandler:null}),d=n?typeof n=="number"?n:n.scroll:null,f=n?typeof n=="number"?n:n.resize:null,w=veranda_mf_2_plugin__loadShare__react__loadShare__.useRef(false);veranda_mf_2_plugin__loadShare__react__loadShare__.useEffect(()=>(w.current=true,()=>void(w.current=false)));const[z,m,s]=veranda_mf_2_plugin__loadShare__react__loadShare__.useMemo(()=>{const r=()=>{if(!e.current.element)return;const{left:y,top:C,width:H,height:O,bottom:S,right:x,x:B,y:R}=e.current.element.getBoundingClientRect(),l={left:y,top:C,width:H,height:O,bottom:S,right:x,x:B,y:R};e.current.element instanceof HTMLElement&&i&&(l.height=e.current.element.offsetHeight,l.width=e.current.element.offsetWidth),Object.freeze(l),w.current&&!D(e.current.lastBounds,l)&&h(e.current.lastBounds=l);};return [r,f?g(r,f):r,d?g(r,d):r]},[h,i,d,f]);function v(){e.current.scrollContainers&&(e.current.scrollContainers.forEach(r=>r.removeEventListener("scroll",s,true)),e.current.scrollContainers=null),e.current.resizeObserver&&(e.current.resizeObserver.disconnect(),e.current.resizeObserver=null),e.current.orientationHandler&&("orientation"in screen&&"removeEventListener"in screen.orientation?screen.orientation.removeEventListener("change",e.current.orientationHandler):"onorientationchange"in window&&window.removeEventListener("orientationchange",e.current.orientationHandler));}function b(){e.current.element&&(e.current.resizeObserver=new a(s),e.current.resizeObserver.observe(e.current.element),t&&e.current.scrollContainers&&e.current.scrollContainers.forEach(r=>r.addEventListener("scroll",s,{capture:true,passive:true})),e.current.orientationHandler=()=>{s();},"orientation"in screen&&"addEventListener"in screen.orientation?screen.orientation.addEventListener("change",e.current.orientationHandler):"onorientationchange"in window&&window.addEventListener("orientationchange",e.current.orientationHandler));}const L=r=>{!r||r===e.current.element||(v(),e.current.element=r,e.current.scrollContainers=E(r),b());};return X(s,!!t),W(m),veranda_mf_2_plugin__loadShare__react__loadShare__.useEffect(()=>{v(),b();},[t,s,m]),veranda_mf_2_plugin__loadShare__react__loadShare__.useEffect(()=>v,[]),[L,c,z]}function W(n){veranda_mf_2_plugin__loadShare__react__loadShare__.useEffect(()=>{const t=n;return window.addEventListener("resize",t),()=>void window.removeEventListener("resize",t)},[n]);}function X(n,t){veranda_mf_2_plugin__loadShare__react__loadShare__.useEffect(()=>{if(t){const o=n;return window.addEventListener("scroll",o,{capture:true,passive:true}),()=>void window.removeEventListener("scroll",o,true)}},[n,t]);}function E(n){const t=[];if(!n||n===document.body)return t;const{overflow:o,overflowX:i,overflowY:a}=window.getComputedStyle(n);return [o,i,a].some(c=>c==="auto"||c==="scroll")&&t.push(n),[...t,...E(n.parentElement)]}const k=["x","y","top","bottom","left","right","width","height"],D=(n,t)=>k.every(o=>n[o]===t[o]);
...
function CanvasImpl({
  ...
  veranda_mf_2_plugin__loadShare__react__loadShare__.useMemo(() => extend(THREE), []);
  ...
  const canvasRef = veranda_mf_2_plugin__loadShare__react__loadShare__.useRef(null);
  const divRef = veranda_mf_2_plugin__loadShare__react__loadShare__.useRef(null);
  veranda_mf_2_plugin__loadShare__react__loadShare__.useImperativeHandle(ref, () => canvasRef.current);
  const handlePointerMissed = useMutableCallback(onPointerMissed);
  const [block, setBlock] = veranda_mf_2_plugin__loadShare__react__loadShare__.useState(false);
  const [error, setError] = veranda_mf_2_plugin__loadShare__react__loadShare__.useState(false);

  // Suspend this component if block is a promise (2nd run)
  if (block) throw block;
  // Throw exception outwards if anything within canvas throws
  if (error) throw error;
  const root = veranda_mf_2_plugin__loadShare__react__loadShare__.useRef(null);
  useIsomorphicLayoutEffect(() => {
    ...
    if (containerRect.width > 0 && containerRect.height > 0 && canvas) {
      ...
      async function run() {
        ...
        root.current.render( /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(Bridge, {
          children: /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(ErrorBoundary, {
            set: setError,
            children: /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(veranda_mf_2_plugin__loadShare__react__loadShare__.Suspense, {
              fallback: /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(Block, {
                set: setBlock
              }),
  ...
  return /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx("div", {
    ref: divRef,
    style: {
      position: 'relative',
      width: '100%',
    ...
    ...props,
    children: /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx("div", {
      ref: containerRef,
      style: {
        width: '100%',
        height: '100%'
      },
      children: /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx("canvas", {
        ref: canvasRef,
        style: {
          display: 'block'
        },
...
function Canvas(props) {
  return /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(m, {
    children: /*#__PURE__*/veranda_mf_2_plugin__loadShare__react_mf_1_jsx_mf_2_runtime__loadShare__.jsx(CanvasImpl, {
      ...props
    })
  });
}
